...
Смотрю логи подключения к серверу

![Логи подключения](imgs/11.PNG)

Видно что авторизация прошла успешно

![Успешная авторизация](imgs/12.PNG)

Теперь посмотрим конфигурацию IPSec. Видно, что leftid это IP нашего сервера.

![Конфигурационный файл авторизация](imgs/13.PNG)

Здесь видно пул адресов, из которого берутся IP адреса

![Пул адресов](imgs/14.PNG)

## Настройка L2TP
Для начала нужно настроить L2TP. Настроим пул адресов из котого будут выдаваться Ip адреса клиентам.

![Настройки L2TP](imgs/15.PNG)

Установим DNS сервера на сервера Google и включим логгирование

![Установка DNS серверов](imgs/16.PNG)
